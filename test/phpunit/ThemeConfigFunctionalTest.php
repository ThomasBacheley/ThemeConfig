...
/**
 * \file    test/phpunit/ThemeConfigFunctionalTest.php
 * \ingroup themeconfig
...
/**
 * Class ThemeConfigFunctionalTest
 *
 ...
 *
 * @package Testthemeconfig
 */
class ThemeConfigFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modThemeConfig')->click();
		} else {
			// Disable the module
			$this->byHref('modThemeConfig')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/themeconfig/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('themeconfig/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/themeconfig/admin/about.php');
		$this->authenticate();
		return $this->assertContains('themeconfig/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('themeconfigwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modThemeConfig_ThemeConfigTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modThemeConfig_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
